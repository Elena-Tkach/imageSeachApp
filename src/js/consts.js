export const cards = [
...

  {
    ...
    title: 'sports in yellow',
    likes: 150,
    date: '04/09/22',
    tags: ['Yellow', 'Blue', 'Sport'],
...

  {
    ...
    title: 'fruit and berry delicacies',
    likes: 102,
    date: '05/12/21',
    tags: ['Fruit', 'Woman',],
    author: 'Emely Thompson',
  },
...

  {
    ...
    title: 'delicious dessert yellow background',
    likes: 12,
    date: '12/09/20',
    tags: ['Yellow', 'Food', 'Dessert'],
